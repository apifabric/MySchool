...
resourcename="myschool"  # lower case, only
resourcegroup="myschool_rg"
...
# git clone https://github.com/apilogicserver/myschool.git
# cd myschool
...
az group create --name myschool_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group myschool_rg --sku S1 --is-linux
az container create --resource-group myschool_rg --name myschool --image apilogicserver/myschool:latest --dns-name-label myschool --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//myschool.westus.azurecontainer.io:5656'
